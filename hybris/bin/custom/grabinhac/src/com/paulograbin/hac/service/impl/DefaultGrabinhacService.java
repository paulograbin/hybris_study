...
public class DefaultGrabinhacService implements GrabinhacService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGrabinhacService.class);
	...
	{
		return DefaultGrabinhacService.class.getResourceAsStream("/grabinhac/sap-hybris-platform.png");
	}
