...
public class DefaultGrabinimpexloaderService implements GrabinimpexloaderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGrabinimpexloaderService.class);
	...
	{
		return DefaultGrabinimpexloaderService.class.getResourceAsStream("/grabinimpexloader/sap-hybris-platform.png");
	}
