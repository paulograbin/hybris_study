 ...
 */
package com.paulograbin.occ.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.paulograbin.occ.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "grabinwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "grabinwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "grabinwebservices.oauth2.tokenUrl";

	private static final String DESC = "grabinwebservices.v2.description";
	private static final String TITLE = "grabinwebservices.v2.title";
	private static final String VERSION = "grabinwebservices.v2.version";
